...
## Render plot2.R, which displays global active power over two-day period and save as plot2.png file in working directory
png("plot2.png", width = 480, height = 480, units = "px", res = 72)
par(mar = c(3.2, 4.25, 3, 0.75))
plot(data4.df$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xaxt = "n")
