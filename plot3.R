...
## Render plot3.R, which displays Sub-metering 1, 2, & 3, and then save as plot3.png file in working directory
png("plot3.png", width = 480, height = 480, units = "px", res = 72)
par(mar = c(3.2, 4.25, 3, 0.75))
plot(data4.df$Sub_metering_1, type = "l", col = "black", ylab = "Energy sub metering", xaxt = "n")
points(data4.df$Sub_metering_2, type = "l", col = "red", ylab = "Energy sub metering", xaxt = "n")
points(data4.df$Sub_metering_3, type = "l", col = "blue", ylab = "Energy sub metering", xaxt = "n")
